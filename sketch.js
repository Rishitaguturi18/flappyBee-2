...
function preload(){
bgImg = loadImage("assets/YellowCloud.png")
...
//background image
bg = createSprite(165,785,1,1);
bg.addImage(bgImg);
bg.scale = 1.5


//creating top and bottom grounds
bottomGround = createSprite(200,500,1000,20);
bottomGround.visible = true;


topGround = createSprite(200,0.5,1000,20);
